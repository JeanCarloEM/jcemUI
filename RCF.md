...
### 3.2 Compatibilidade nativa extensível

A biblioteca DEVE oferecer integração explícita e testada, por adaptadores independentes, com:

- vanilla;
- Vite como ferramenta opcional de desenvolvimento/build;
- React;
- Preact;
- Zag.js;
- Font Awesome;
...
Compatibilidade PODE ser ampliada para novas bibliotecas. Compatibilidade declarada NÃO DEVE ser retirada, bloqueada ou tornada mutuamente exclusiva sem versão principal, migração, fallback e autorização normativa. Adaptador não selecionado NÃO DEVE entrar no artefato do consumidor.
...
4. **matriz de consumo**: vanilla sem bundler; Vite; React; Preact; Zag.js; providers Font Awesome/Web Awesome; ausência explícita de cada opcional;
